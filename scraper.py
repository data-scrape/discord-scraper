#!/usr/bin/env python3
"""
Discord Scraper - Scrape Discord messages, channels, members without API
Open source scraper for discord scraper, scrape discord, discord message scraper
...
class DiscordScraperScraper:
    """Scraper for Discord Scraper."""
...
def main():
    parser = argparse.ArgumentParser(description="Discord Scraper - Scrape Discord messages, channels, members without API")
    ...
    scraper = DiscordScraperScraper(proxy=args.proxy)
